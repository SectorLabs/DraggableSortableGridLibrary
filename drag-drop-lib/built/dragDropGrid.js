...
var DragDropGrid = /** @class */ (function (_super) {
    ...
    function DragDropGrid(props) {
        ...
        _this.saveBlockPositions = function (key) { return function (_a) {
        ...
        _this.activateDrag = function (key) { return function () {
            _this.release = false;
        ...
        _this.onActiveBlockIsSet = function (fn) { return function (evt, gestureState) {
            if (_this.state.activeBlock != null)
                fn(evt, gestureState);
        }; };
        _this._getImageDeleteIconStyle = function (key) { return [
            {
                position: 'absolute',
        ...
        _this._getGridStyle = function () { return [
            styles.sortableGrid,
            _this.props.style,
            _this._blockPositionsSet() && { height: _this.state.gridHeight }
        ]; };
        _this._getItemWrapperStyle = function (key) { return [
            { flex: 1 },
            _this.state.activeBlock == key &&
